...
## Vabrialbes de Criaderos
CRIADEROS=extraer_redcap('http://claimproject.com/redcap570/api/',
                         '3F40C134AB18048FD695845BC1E6716F' ,
                         ['record_id', 'mosquito_breeding_code', 'latitude','longitude'] )




####IN: list of people Out:list of positive malaria cases. 
def positivos_malaria_pais(SUBSET_SINTOMAS,PAIS):
    ...
    return POSITIVOS
####IN: list of people Out:list of positive dengue cases.
...
#### IN: LIST OF HOUSES , ID COUNTRY Out: list of houses of the country
...
## IN: List of Positive Malaria cases, List of Houses Out: Houses whit malaria cases
...
## IN: List of Positive Dengue cases, List of Houses Out: Houses whit Dengue cases
...
####  variable printing to be used in php      
def to_php(SUBSET):
##    M=[]
##    j=0
    for i in SUBSET:
...
CASOS_POSITIVOS_DENGUE= positivos_dengue_pais(SINTOMAS,'4')

CASOS_POSITIVOS_MALARIA= positivos_malaria_pais(SINTOMAS,'4')
CASAS_COLOMBIA= casas_colombia(SOCIODEMOGRAFICA,'4')
