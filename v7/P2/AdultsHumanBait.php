...
$criaderos= array();
exec("..\python\AdultsHumanBait.py",$criaderos);
...
<html>
  <head>
    <meta charset="utf-8">
    <title>CLAIM - P2 Adults Human Bait</title>
    <style>
...
function initialize() {
  ...
  var icono_criadero='../markers/mosquito_breeding/bullet_blue.png';
   <?php	  
	...
	for($j=0;$j<count($long_criaderos);$j++)
	{
	 echo"var contenido='<div  style=\'width: 160px; \'> Codigo:</br> <a href=\'http://claimproject.com/redcap570/redcap_v6.9.4/DataEntry/index.php?pid=187&page=informacin_de_la_persona_seleccionada_para_la_toma&id=0\'> </a> <br>Tipo:</div>';";
