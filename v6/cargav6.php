...
$variables_py= array(); //recogerá los datos que nos muestre el script de Python
 exec("google_maps_pointsV6.py",$variables_py);
...
<!--<script src="http://maps.google.com/maps/api/js?sensor=false" type="text/javascript"></script>-->
	...
	var imageBounds = new google.maps.LatLngBounds(
      ...
      new google.maps.LatLng(5.72230, -76.625555));//derecha --arriba
		  ...
		  var icono='markers/house/simple_blue_house.png';
  ...
  cloudLayer.setMap(mapa);*/
	...
	<?php	  for($j=0;$j<count($long);$j++)
		   {
		   if ($year=="null" and $tipo_enfermedad=="null" and $area=="null") /// MARCA TODOS LOS PUNTOS EN AZUL LA PRIMERA VEZ
		   {
		   echo"var contenido='<div  style=\'width: 150px; \'> Codigo:</br> <a href=\'http://claimproject.com/redcap570/redcap_v6.9.4/DataEntry/index.php?pid=6&page=conocimientos_actitudes_prcticas_y_sociodemogrfica&id=$codigo[$j]\'> $codigo[$j] </a> </div>';";
...
<div id="wrapper">
<div id="content">
<div id="tamaño" style="width:600px; height:400px"> </div>
  </div>
</div>
<div id="navigation">
...
<img src="markers/house/simple_blue_house.png">: Casa encuestada.<br>
